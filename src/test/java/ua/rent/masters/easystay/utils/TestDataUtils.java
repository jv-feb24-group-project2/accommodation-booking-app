...
public class TestDataUtils {
    ...
    public static final String ADD_ACCOMMODATIONS =
            "database/accommodation/add-accommodations.sql";
    public static final String ADD_ACCOMMODATIONS_AMENITIES =
            "database/accommodation/add-accommodations-amenities.sql";
    ...
    @SneakyThrows
    public static void beforeEachAccommodationTest(DataSource dataSource) {
        tearDown(dataSource);
        try (Connection connection = dataSource.getConnection()) {
            connection.setAutoCommit(true);
            ...
            ScriptUtils.executeSqlScript(connection,
                    new ClassPathResource(ADD_ACCOMMODATIONS));
            ScriptUtils.executeSqlScript(connection,
                    new ClassPathResource(ADD_ACCOMMODATIONS_AMENITIES));
        }
    }
